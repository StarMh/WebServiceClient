package cn.wangtao34.webservice.pic;
...
public class VerifyCodeService {
	 ...
	 * 
	 * @author wangtao34
	 * @time 2017年8月18日 上午9:37:16
	 * @param code
	 * @return
	 */
	public  byte[] outputByte(String code) {
		int w = 200, h = 80;
		try {
			BufferedImage image = outputImage(w, h, code);
			ByteArrayOutputStream out = new ByteArrayOutputStream();
	 ...
	 * @throws IOException
	 */
	private  BufferedImage outputImage(int w, int h, String code) throws IOException {
...
//		VerifyCodeService s = new VerifyCodeService();
//		byte[] b = s.outputByte();
//		ByteArrayInputStream in = new ByteArrayInputStream(b);
//		BufferedImage image = ImageIO.read(in);
//		File outputFile = new File("F:\\verifies\\test.jpg");
//		FileOutputStream fos = new FileOutputStream(outputFile);
//		ImageIO.write(image, "jpg", fos);
//		in.close();
//		fos.close();
